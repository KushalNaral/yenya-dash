...
// Reversed year range for display (descending order - current year first)
const reversedYearRange = computed(() => {
  return Array.from(yearRange.value).reverse();
});
  ...
  <DefineYearTemplate v-slot="{ date }">
    <div class="**:data-[slot=native-select-icon]:right-1">
      <div class="relative">
        ...
        >
          <NativeSelectOption
            v-for="year in reversedYearRange"
            :key="year.toString()"
            :value="year.year"
